// items.js
// Server-side weapon, armor, spell, and special definitions.
// Must match the keys used in the client's itemDefs.js
const WEAPONS = {
  // Pig-Leather tier (1)
...
module.exports = { WEAPONS, ARMORS, SPELLS, SPECIALS };